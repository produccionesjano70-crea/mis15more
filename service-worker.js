const CACHE_NAME = 'cache-v5'; // Use a static or manually managed version
const RESOURCES_TO_PRECACHE = [
    'estilos/normalize.css?v5',
    'estilos/styles.css?v5',
    'estilos/mediaQueries.css?v5',
    'javascript/script.js?v5',
