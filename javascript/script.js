...
function updateTimer() {
  const targetDate = new Date("october 16, 2026 21:00:00").getTime();
...
document.addEventListener('DOMContentLoaded', function() {
  ...
  const phoneNumber1 = '543837693771'; // Número para el primer botón
  const phoneNumber2 = '543837693771'; // Número para el segundo botón
...
document.addEventListener('DOMContentLoaded', function() {
  // Definir los números de teléfono
  const recipientNumber1 = '543837693771'; // Número para el primer botón
  const recipientNumber2 = '543837693771'; // Número para el segundo botón
